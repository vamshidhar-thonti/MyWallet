...
<%@taglib prefix="dep" uri="http://www.springframework.org/tags/form"%>
...
<body>
	<center>
		<div
			...
			<dep:form action="depositNow" modelAttribute="deposit" method="post">
				<h1>
					<u>Deposit money</u>
				</h1>
				<table>
